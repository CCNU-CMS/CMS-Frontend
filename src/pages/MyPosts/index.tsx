import { deletePost, getUserInfo, getUserPosts } from '@/services/ant-design-pro/api';
...
const MyPosts: React.FC = () => {
  ...
  const updatePosts = (id: number) => {
    if (token) {
      getUserPosts(id, token).then((res) => {
        setPosts(res.data);
